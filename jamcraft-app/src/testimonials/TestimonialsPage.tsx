    ...
    <Container size="xl" py="xl" px={{ base: 'md', sm: 'xl' }}>
      <Stack gap="xl">
        ...
        >
          ...
          <PageHeader
            title="Testimonials"
            subtitle="What if the Bob's Burgers cast reviewed this portfolio?"
            align="center"
          />
          ...
          >
            (Spoiler: They didn't. Claude Code did. These are satirical, AI-generated quotes.)
          </Text>
        </div>
        ...
        >
          ...
          >
            ...
            for entertainment purposes. The Bob's Burgers characters have never reviewed this portfolio. Any resemblance to actual statements
            by real people or characters is purely coincidental and satirical in nature.
          </Text>
        </div>
      </Stack>
    </Container>
